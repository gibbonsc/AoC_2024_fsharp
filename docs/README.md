...
this helpful VS Code key binding configuration; below is my
`keybindings.json` file. I created it using the Command Palette's
...
a good mnemonic for both "inline" and "Ionide." This configuration
depends on another VS Code extension, Cody Hoover's **Settings Cycler**.
